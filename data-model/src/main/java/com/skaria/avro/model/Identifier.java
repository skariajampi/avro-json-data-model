...
public class Identifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7281585678650288384L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Identifier\",\"namespace\":\"com.skaria.avro.model\",\"fields\":[{\"name\":\"identifier\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
  ...
  /**
   * Gets the value of the 'identifier' field as an Optional&lt;java.lang.String&gt;.
   * @return The value wrapped in an Optional&lt;java.lang.String&gt;.
   */
  public Optional<java.lang.String> getOptionalIdentifier() {
    return Optional.<java.lang.String>ofNullable(identifier);
  }
   ...
   */
  public static com.skaria.avro.model.Identifier.Builder newBuilder() {
    return new com.skaria.avro.model.Identifier.Builder();
  }
   ...
   * @return A new Identifier RecordBuilder
   */
  public static com.skaria.avro.model.Identifier.Builder newBuilder(com.skaria.avro.model.Identifier.Builder other) {
    if (other == null) {
      return new com.skaria.avro.model.Identifier.Builder();
    } else {
      return new com.skaria.avro.model.Identifier.Builder(other);
    }
  }
   ...
   * @return A new Identifier RecordBuilder
   */
  public static com.skaria.avro.model.Identifier.Builder newBuilder(com.skaria.avro.model.Identifier other) {
    if (other == null) {
      return new com.skaria.avro.model.Identifier.Builder();
    } else {
      return new com.skaria.avro.model.Identifier.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Identifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.skaria.avro.model.Identifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.skaria.avro.model.Identifier other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.identifier)) {
        this.identifier = data().deepCopy(fields()[0].schema(), other.identifier);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skaria.avro.model.Identifier.Builder setIdentifier(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skaria.avro.model.Identifier.Builder clearIdentifier() {
      identifier = null;
