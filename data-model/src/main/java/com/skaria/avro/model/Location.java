...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5003652237145590008L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Location\",\"namespace\":\"com.skaria.avro.model\",\"fields\":[{\"name\":\"latitude\",\"type\":\"double\"},{\"name\":\"longitude\",\"type\":\"double\"}]}");
   ...
   */
  public static com.skaria.avro.model.Location.Builder newBuilder() {
    return new com.skaria.avro.model.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.skaria.avro.model.Location.Builder newBuilder(com.skaria.avro.model.Location.Builder other) {
    if (other == null) {
      return new com.skaria.avro.model.Location.Builder();
    } else {
      return new com.skaria.avro.model.Location.Builder(other);
    }
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.skaria.avro.model.Location.Builder newBuilder(com.skaria.avro.model.Location other) {
    if (other == null) {
      return new com.skaria.avro.model.Location.Builder();
    } else {
      return new com.skaria.avro.model.Location.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.skaria.avro.model.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.skaria.avro.model.Location other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skaria.avro.model.Location.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skaria.avro.model.Location.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skaria.avro.model.Location.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skaria.avro.model.Location.Builder clearLongitude() {
