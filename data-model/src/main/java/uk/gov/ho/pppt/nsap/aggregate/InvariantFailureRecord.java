 ...
 */
package uk.gov.ho.pppt.nsap.aggregate;
...
public class InvariantFailureRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder newBuilder() {
    return new uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder();
  }
   ...
   * @return A new InvariantFailureRecord RecordBuilder
   */
  public static uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder newBuilder(uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder other) {
    if (other == null) {
      return new uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder();
    } else {
      return new uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder(other);
    }
  }
   ...
   * @return A new InvariantFailureRecord RecordBuilder
   */
  public static uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder newBuilder(uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord other) {
    if (other == null) {
      return new uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder();
    } else {
      return new uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InvariantFailureRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.invariantId)) {
        this.invariantId = data().deepCopy(fields()[0].schema(), other.invariantId);
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder setInvariantId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder clearInvariantId() {
      invariantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder setInvariantName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder clearInvariantName() {
      invariantName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder setExternalDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder clearExternalDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder setInternalDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.ho.pppt.nsap.aggregate.InvariantFailureRecord.Builder clearInternalDescription() {
